...
if opt.model_name == 'resnet':
    ...
    if opt.target_ratio <= 0.125:
        if opt.arch == 4:
            ...
            print('---------- resnet_B_width')  
        elif opt.arch == 3:
            model_func = resnet_B_compound_cifar100
            print('---------- resnet_B_compound')     
        else:
